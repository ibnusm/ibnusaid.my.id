  ...
  fetch(
    ...
    .then((data) => {
      ...
      if (data.meals) {
        data.meals.forEach((meal) => {
          html += `
                    <div class = "meal-item" data-id = "${meal.idMeal}">
                        ...
                        <div class = "meal-name">
                            <h3>${meal.strMeal}</h3>
                            <a href = "#" class = "recipe-btn">Tampilkan Resep Makanan</a>
                        </div>
                    </div>
                `;
        });
        ...
        html = "Maaf, resep makanan yang kamu cari tidak ada :(";
...
function mealRecipeModal(meal) {
  ...
  let html = `
        ...
        <h2 class="title">Nama Bahan Bahan</h2>
        ...
        <cite>By IbnuSaid</cite> check my <a href="https://chinulz.github.io" target="blank">Portfolio</a>
    `;
